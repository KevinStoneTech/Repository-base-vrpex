...
--[ WEBHOOK ]----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
local logEntrada = "https://discord.com/api/webhooks/1059547795742281838/Rk0X-NjpYE-O-OqAJ_rfIMIjg7oMaUxkSkjgAt-EcQBvCntnabaI220mIlq4LJD5_GqS" -- OK 02/01/2023
local logSaida = "https://discord.com/api/webhooks/1059548231983431720/v-ttxV5FDTlZqT4v0otOaeSJjxaxy36BmXWoZdkyCu8-IWEeiO9qZftY5ATfKcQTSjcX" -- OK 02/01/2023
local policiaPonto = ""
local resgatePonto = ""
-----------------------------------------------------------------------------------------------------------------------------------------
--[ BASE.LUA ]---------------------------------------------------------------------------------------------------------------------------
		...
		if user_id then
			...
			if not vRP.isBanned(user_id) then
				...
				if vRP.isWhitelisted(user_id) then
					...
					deferrals.done("Envie SEU ID APROVAMOS NA HORA https://discord.gg/teudisc ID: "..user_id.." ]")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Você foi banido da cidade ENTRE EM NOSSO https://discord.gg/teudisc ID: "..user_id.." ]")
				--print(user_id)
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
