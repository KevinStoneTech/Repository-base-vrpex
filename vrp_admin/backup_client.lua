...
AddEventHandler('admcuff',function(args)
...
--[ CUFF ]-----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('admcuff2')
AddEventHandler('admcuff2',function(args)
	local ped = PlayerPedId()
		vRP._setHandcuffed(source,true)
		SetPedComponentVariation(source,7,41,0,2)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
--[ SYNCAREA ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
