...
*/
  ...
  $(".btnQuestion").click(function(){
      $.post('http://vrp_habilitacao/question', JSON.stringify({}));
  });
  $(".btnClose").click(function(){
      $.post('http://vrp_habilitacao/close', JSON.stringify({nbGoodAnswer}));
  });
  $(".btnKick").click(function(){
      ...
      randomQuestion = 0;
	  skip = 0;
      $.post('http://vrp_habilitacao/kick', JSON.stringify({nbGoodAnswer}));
	  nbGoodAnswer = 0;
  });
